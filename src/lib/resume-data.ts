...
export const resumeDocuments: Record<Locale, ResumeDocumentCopy> = {
  en: {
    ...
    totalExperience: "7 years 1 month",
    focusLabel: "Target roles",
    focusValue: "Growth PM / Operations PM / Data PM",
    scopeLabel: "Operating range",
    scopeValue: "Data build, robotics service, public-sector project, hospitality operations, military leadership",
    sourceNote: "Rebuilt from the public-safe career description PDF in the reference folder.",
  ...
  ko: {
    ...
    totalExperience: "총 7년 1개월",
    focusLabel: "희망 역할",
    focusValue: "Growth PM / Operations PM / Data PM",
    scopeLabel: "경험 범위",
    scopeValue: "데이터 구축, 로봇배달 서비스, 공공사업 운영, 서비스 운영, 장교 리더십",
    sourceNote: "참고자료 폴더의 경력기술서 PDF를 기준으로 웹 화면에 맞게 재구성했습니다.",
