        ...
        <div className="flex flex-wrap gap-2">
          {companies.map((company) => (
            <Link
              ...
              className="rounded-md border border-neutral-200 px-3 py-2 text-sm leading-5 text-neutral-700 transition hover:border-brand-green hover:text-brand-green-deep"
            >
