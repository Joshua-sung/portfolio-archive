    ...
    entries: [
      {
        ...
        role: [
          ...
          "운영 요구사항을 바탕으로 개발자와 추가 기능 및 개선 방향을 논의하고 서비스 운영 프로세스 고도화",
          "수작업, 협업 요청 흐름 등을 자동화·도구화해 월 21시간 절감 및 수동 검수 처리량 4.21배 개선",
        ],
        tools: "CSV/JSON 분석, Google Apps Script, AI 에이전트 활용, KPI 리포팅, 영업자료 데이터 시각화",
      },
      {
