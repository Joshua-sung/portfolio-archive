  ...
  return (
    <>
      ...
      >
        <div
          aria-hidden="true"
          className="pointer-events-none absolute inset-0 -z-10 bg-[radial-gradient(ellipse_60%_50%_at_78%_0%,rgba(79,94,240,0.20),transparent_70%),radial-gradient(ellipse_50%_40%_at_10%_100%,rgba(254,91,44,0.07),transparent_70%)]"
        />
        <Container>
          <div className="grid gap-8 py-10 lg:grid-cols-[minmax(0,1fr)_360px] lg:items-center lg:py-14">
            <div className="min-w-0">
              <div className="flex max-w-full flex-col items-start gap-2 sm:flex-row sm:flex-wrap sm:items-center">
                <p
                  ...
                  className="max-w-full break-words rounded-full border border-white/15 bg-white/5 px-3 py-1.5 text-xs font-semibold uppercase tracking-wide text-neutral-200"
                >
                  {copy.eyebrow}
                </p>
                <p
              ...
              <h1
                ...
                className="mt-5 max-w-[22rem] break-keep text-4xl font-semibold leading-[1.08] tracking-tight text-white sm:max-w-4xl sm:text-6xl"
              >
                {copy.title}
              </h1>
              <p
              ...
              <p
                ...
                className="mt-4 max-w-[22rem] break-keep text-base leading-7 text-neutral-400 sm:max-w-2xl sm:text-lg sm:leading-8"
              >
                {copy.description}
              </p>
              <div className="mt-7 flex flex-wrap gap-3">
                ...
                <Link
                  ...
                  href={contactUrl}
                  className="inline-flex min-h-11 items-center justify-center gap-2 rounded-full bg-brand-green-deep px-5 py-3 text-sm font-semibold text-white transition hover:bg-brand-green"
                >
            ...
            >
              <div
                ...
                className="mb-5 rounded-2xl bg-[radial-gradient(circle_at_20%_10%,#FE5B2C_0%,rgba(254,91,44,0)_34%),linear-gradient(135deg,#1A1F7C_0%,#262DA9_55%,#4A57E8_100%)] p-5 text-white"
              >
                <p className="text-xs font-semibold uppercase tracking-[0.12em] text-white/80">{copy.impactEyebrow}</p>
          ...
          <div className="border-t border-white/10 py-7">
            <div className="mb-4 flex flex-col gap-1 sm:flex-row sm:items-end sm:justify-between">
              <div>
                <p className="text-xs font-semibold uppercase tracking-[0.12em] text-brand-orange">{copy.impactEyebrow}</p>
                <h2 className="mt-2 text-2xl font-semibold tracking-tight text-white">{copy.impactTitle}</h2>
              </div>
            </div>
            <div className="grid grid-cols-2 gap-3 sm:grid-cols-3 lg:grid-cols-6">
              {localizedImpactMetrics.map((metric) => (
                ...
                >
                  ...
                  <p className="mt-2 text-xs font-semibold uppercase leading-4 tracking-wide text-neutral-200">{metric.label}</p>
        ...
        <Container>
          <div className="mb-8 flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
            <div className="max-w-3xl">
              <p className="text-xs font-semibold uppercase tracking-[0.12em] text-brand-orange">{copy.casesEyebrow}</p>
              <h2 className="mt-2 text-3xl font-semibold tracking-tight text-white">{copy.casesTitle}</h2>
      ...
      <section className="border-y border-neutral-200 bg-brand-bg py-14">
        <Container>
          <div className="mb-8 max-w-3xl">
            <p className="text-xs font-semibold uppercase tracking-[0.12em] text-brand-blue">{copy.capabilitiesEyebrow}</p>
            <h2 className="mt-2 text-3xl font-semibold tracking-tight text-neutral-950">{copy.capabilitiesTitle}</h2>
          </div>
